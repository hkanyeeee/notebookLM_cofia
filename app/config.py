...
WEB_SEARCH_MAX_QUERIES = int(get_config_value("WEB_SEARCH_MAX_QUERIES", "12"))  # 总搜索查询数量上限
...
# 知识缺口和关键词限制
MAX_KNOWLEDGE_GAPS = int(get_config_value("MAX_KNOWLEDGE_GAPS", "8"))  # 用于网络搜索的知识缺口最多10个
